...
*/
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .antMatchers(HttpMethod.GET, "/api/products/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.POST, "/api/products/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.PUT, "/api/products/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.DELETE, "/api/products/**").hasAnyRole("USUARIO")

                .antMatchers(HttpMethod.GET, "/api/orders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.POST, "/api/orders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.PUT, "/api/orders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.DELETE, "/api/orders/**").hasAnyRole("USUARIO")

                .antMatchers(HttpMethod.GET, "/api/productorders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.POST, "/api/productorders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.PUT, "/api/productorders/**").hasAnyRole("USUARIO")
                .antMatchers(HttpMethod.DELETE, "/api/productorders/**").hasAnyRole("USUARIO")

                .antMatchers(HttpMethod.GET, "/api/users/{id}").hasAnyRole("USUARIO")
